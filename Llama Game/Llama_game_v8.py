# Detects collisions by making a red box around the llama everytime the
# llama collides with the cactus
    ...
    while running:
        ...
        for obstacle in obstacles:
            ...
            if player.llama_rect.colliderect(obstacle.rect):
                pygame.draw.rect(SCREEN, (255, 0, 0), player.llama_rect, 2)
